...
<head>
    ...
    <title>Unidades territoriais | SIGEDC</title>
    <style>
        :root {
            --bg: #f3f6fb;
            --card: #ffffff;
        ...
        * { box-sizing: border-box; }
        ...
        .field input, .field select { width: 100%; border: 1px solid var(--border); border-radius: 8px; padding: 10px; }
...
<main class="container">
    <section class="topbar">
        <h1 class="title">Base Territorial - Unidades territoriais</h1>
        <div class="actions">
